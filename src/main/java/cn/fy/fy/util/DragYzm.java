...
//    private static String imgPath = "";
    private static String sourceImgPath = ClassUtils.getDefaultClassLoader().getResource("static").getPath()+"/img/";

    //    private static final String tempYzmImg = "tempYzmImg";
//private static final String tempYzmImg = "tempYzmImg";
    private static final String sourceYzmImg = "img";
...
//        imgPath = context.getRealPath("/") + tempYzmImg;
        ...
        String savePath = staticPath + "/img/";
        //sourceImgPath = context.getRealPath("/") + sourceYzmImg;
        sourceImgPath=savePath;
    }
